...
from .assinatura import assinar_xml
...
def montar_soap_distdfe(cnpj: str, cuf: str, ultimo_nsu: str, ambiente: int) -> str:
...
def consultar_distdfe(cnpj: str, cert_base64: str, cert_senha: str, ambiente: str, ultimo_nsu: str = "0"):
    cert_file, key_file = extrair_cert_pem(cert_base64, cert_senha)
    try:
        tp_amb = 1 if ambiente == "producao" else 2
        cuf = "35"  # SP como padrão, pode ser configurado
...
def processar_resposta_distdfe(xml_resp: str):
    try:
        ns = {
